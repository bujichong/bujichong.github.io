	...
	F.prototype ={
		...
		mosuewheel : function () {
			...
			$('body').mousewheel(function (e,d) {
				if (t.lock==0&&d<0) {t.nextpage();}="" if="" (t.lock="=0&&d">0) {t.prevPage();}
			});
		},
