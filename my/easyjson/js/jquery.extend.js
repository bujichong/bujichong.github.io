...
(function($){var escapeable=/["\\\x00-\x1f\x7f-\x9f]/g,meta={'\b':'\\b','\t':'\\t','\n':'\\n','\f':'\\f','\r':'\\r','"':'\\"','\\':'\\\\'};$.toJSON=typeof JSON==='object'&&JSON.stringify?JSON.stringify:function(o){if(o===null){return'null';}
    ...
    if(type==='object'){if(typeof o.toJSON==='function'){return $.toJSON(o.toJSON());}
        if(o.constructor===Date){var month=o.getUTCMonth()+1,day=o.getUTCDate(),year=o.getUTCFullYear(),hours=o.getUTCHours(),minutes=o.getUTCMinutes(),seconds=o.getUTCSeconds(),milli=o.getUTCMilliseconds();if(month<10){month='0'+month;} if(day<10){day="0" +day;}="" if(hours<10){hours="0" +hours;}="" if(minutes<10){minutes="0" +minutes;}="" if(seconds<10){seconds="0" +seconds;}="" if(milli<100){milli="0" +milli;}="" if(milli<10){milli="0" return'"'+year+'-'+month+'-'+day+'t'+="" hours+':'+minutes+':'+seconds+'.'+milli+'z"';}="" if(o.constructor="==Array){var" ret="[];for(var" i="0;i<o.length;i++){ret.push($.toJSON(o[i])||'null');}" return'['+ret.join(',')+']';}="" var="" name,val,pairs="[];for(var" k="" in="" o){type="typeof" k;if(type="=='number'){name='"'+k+'"';}else" if(type="=='string'){name=$.quoteString(k);}else{continue;}" type="typeof" o[k];if(type="=='function'||type==='undefined'){continue;}" val="$.toJSON(o[k]);pairs.push(name+':'+val);}" return'{'+pairs.join(',')+'}';}};$.evaljson="typeof" json="=='object'&&JSON.parse?JSON.parse:function(src){return" eval('('+src+')');};$.secureevaljson="typeof" filtered="src.replace(/\\["\\\/bfnrtu]/g,'@').replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,']').replace(/(?:^|:|,)(?:\s*\[)+/g,'');if(/^[\],:{}\s]*$/.test(filtered)){return" eval('('+src+')');}else{throw="" new="" syntaxerror('error="" parsing="" json,="" source="" is="" not="" valid.');}};$.quotestring="function(string){if(string.match(escapeable)){return'"'+string.replace(escapeable,function(a){var" c="meta[a];if(typeof" c;}="" return'"'+string+'"';};})(jquery);="" jquery.cookie="" d,e,f,g,h,i,j,k,l;if("undefined"="=typeof" b){if(i="null,document.cookie&&""!=document.cookie)for(j=document.cookie.split(";"),k=0;k<j.length;k++)if(l=jQuery.trim(j[k]),l.substring(0,a.length+1)==a+"="){i=decodeURIComponent(l.substring(a.length+1));break}return" i}c="c||{},null===b&&(b="",c.expires=-1),d="",c.expires&&("number"==typeof" c.expires||c.expires.toutcstring)&&("number"="=typeof" c.expires?(e="new" date,e.settime(e.gettime()+1e3*60*60*24*c.expires)):e="c.expires,d=";" expires="+e.toUTCString()),f=c.path?" ;="" path="+c.path:" ",g="c.domain?";" domain="+c.domain:" ",h="c.secure?";" secure":"",document.cookie="[a,"=",encodeURIComponent(b),d,f,g,h].join("")};" jquery.color="" (function(d){d.each(["backgroundcolor","borderbottomcolor","borderleftcolor","borderrightcolor","bordertopcolor","color","outlinecolor"],function(f,e){d.fx.step[e]="function(g){if(!g.colorInit){g.start=c(g.elem,e);g.end=b(g.end);g.colorInit=true}g.elem.style[e]="rgb("+[Math.max(Math.min(parseInt((g.pos*(g.end[0]-g.start[0]))+g.start[0]),255),0),Math.max(Math.min(parseInt((g.pos*(g.end[1]-g.start[1]))+g.start[1]),255),0),Math.max(Math.min(parseInt((g.pos*(g.end[2]-g.start[2]))+g.start[2]),255),0)].join(",")+")"}});function" b(f){var="" e;if(f&&f.constructor="=Array&&f.length==3){return" f}if(e="/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(f)){return[parseInt(e[1]),parseInt(e[2]),parseInt(e[3])]}if(e=/rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(f)){return[parseFloat(e[1])*2.55,parseFloat(e[2])*2.55,parseFloat(e[3])*2.55]}if(e=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(f)){return[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16)]}if(e=/#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(f)){return[parseInt(e[1]+e[1],16),parseInt(e[2]+e[2],16),parseInt(e[3]+e[3],16)]}if(e=/rgba\(0," 0,="" 0\)="" .exec(f)){return="" a.transparent}return="" a[d.trim(f).tolowercase()]}function="" c(g,e){var="" f;do{f="d.css(g,e);if(f!=""&&f!="transparent"||d.nodeName(g,"body")){break}e="backgroundColor"}while(g=g.parentNode);return" b(f)}var="" a="{aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]}})(jQuery);" *="" sochange="" 1.6.2="" -="" simple="" object="" change="" with="" jquery="" (function(a){a.fn.extend({sochange:function(b){b="a.extend({thumbObj:null,btnPrev:null,btnNext:null,changeType:"fade",thumbNowClass:"now",thumbOverEvent:true,slideTime:1000,autoChange:true,clickFalse:true,overStop:true,changeTime:5000,delayTime:300,callback:function(){}},b||{});var" h="a(this);var" i;var="" e="0;var" g;var="" c;var="" f;function="" d(){if(e!="g){if(b.thumbObj){a(b.thumbObj).removeClass(b.thumbNowClass).eq(g).addClass(b.thumbNowClass)}if(b.slideTime<=0){h.eq(e).hide();h.eq(g).show()}else{if(b.changeType=="fade"){h.eq(e).fadeOut(b.slideTime);h.eq(g).fadeIn(b.slideTime)}else{h.eq(e).slideUp(b.slideTime);h.eq(g).slideDown(b.slideTime)}}if(b.callback){b.callback(e,g)}e=g}}function" j(){g="(e+1)%k;d()}h.hide().eq(0).show();if(b.thumbObj){i=a(b.thumbObj);i.removeClass(b.thumbNowClass).eq(0).addClass(b.thumbNowClass);i.click(function(){g=i.index(a(this));d();if(b.clickFalse){return" false}});if(b.thumboverevent){i.hover(function(){g="i.index(a(this));f=setTimeout(d,b.delayTime)},function(){clearTimeout(f)})}}if(b.btnNext){a(b.btnNext).click(function(){if(h.queue().length<1){j()}return" false})}if(b.btnprev){a(b.btnprev).click(function(){if(h.queue().length<1){g="(e+k-1)%k;d()}return" false})}if(b.autochange){c="setInterval(j,b.changeTime);if(b.overStop){h.hover(function(){clearInterval(c)},function(){c=setInterval(j,b.changeTime)})}}}})})(jQuery);" $.extend({="" **="" 地址转换="" tree:dept=""> /base/treeUrl?_code=dept
         */
        url : function(url) {
            var rst = '';
            if (url.indexOf('/') == -1) {
