...
//var idCardId = null;//用来暂存身份证物理ID
            ...
            $ajax.post(b.base + '/ui/sys/dict/getMoreList',paramDict).done(function (rst) {
               // console.log(rst);
                dict = rst.data;
                specialInfoD = dict.special_info;
                specialInfoTypeD = dict.special_info_type;
          ...
          function userFormLoadData(data) {
...
//用户联系人信息 begin
            ...
            $(function () {
                ...
                var bookbuildingDoneInit = false;
                var bookbuildingDone = function (res) {
                    ...
                    if(res.status == '3') {
                        ...
                        $('.searchPatientConfirm').addClass('patientInfoSearchshow');
                    ...
                    ;(function () {
                        ...
                        $(".btn-bookbuildingOldUser").click(function () {
                        	...
                        	if(!res.qrcodeCardNo){
	                            ...
	                            $('.searchPatientConfirm').removeClass('patientInfoSearchshow');
              ...
              //  btn2 && btn2.req(readSocialCard);
                ...
                function initTab1 (patientInfo) {
                    $('#tabsA').tabs('select', 0);
                    userFormLoadData(patientInfo);
                    var birthday =  patientInfo.birthday.substring(0,10);
                    $("#age").val($T.getAgeByBir(birthday));
                    $("#birthday").val(birthday);
                    b.patientId = patientInfo.id;
                        ...
                        $ajax.post(b.base + '/ui/outp/patientInfo/isSendCard', userInfo, '是否为该用户发新卡？', false, false, true).done(function (rst) {//用carId发送请求到服务器端
                            if (rst.code === '200' || rst.code === '201') {
                                ...
                                if (state == '2') {//用户在数据里无信息档案
                                    ...
                                    $ajax.post(b.base + '/ui/outp/patientInfo/createArchives', userInfo).done(function (nrst) {//系统返回201提示为用户发卡成功,并返回b.patientId {"code":"201","msg":"为该用户发卡成功！","list":{patientId:'1245555'}}
...
//                        window.console && console.log('contactInfoChange run');
                ...
                $grid.newGrid("#grid-l-contact", {
                    ...
                    columns: [[
                        ...
                        {title: '联系人姓名', field: 'name', width: 80, editor: {type: 'validatebox', options: {required: true}}},
                        {
                        ...
                        {title: '证件号码', field: 'certNumber', width: 150, editor: {type: 'diy', options: {required: true}}},
