    ...
    $pop.popTemForm = function (opt){
        ...
        afterSubmit : null//提交之后的事件, function (rst,$formBox) {}
            ...
            var temPop =  $pop.open({
                ...
                area : opt.area,
                btn : opt.btn,
                success : function ($pop,index){
                        var $form = $pop.find('.form-validate');
                        ...
                        $pop.find('.btn-cancel').click(function (){
                            layer.close(index);
                        });
                        opt.onPop($pop);
                },
    ...
    rangeDate : function ($range,opt) {
      var $range =$range?$($range) : $('.so-rangeDate');
        require(['moment'],function (moment) {
            ...
            var ranges = {
                '今天': [moment().hour(0).minute(0).second(0), moment()],
                '昨天': [moment().subtract(1, 'days').hour(0).minute(0).second(0), moment().subtract(1, 'days').hour(23).minute(59).second(59)],
                '最近一周': [moment().subtract(6, 'days').hour(0).minute(0).second(0), moment().hour(23).minute(59).second(59)],
                '最近30天': [moment().subtract(29, 'days').hour(0).minute(0).second(0), moment().hour(23).minute(59).second(59)],
